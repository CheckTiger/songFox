...
public final class ShMediaType {
    ...
    private ShMediaType(String mediaType, String type, String subtype, @Nullable String charset) {
    ...
    ShMediaType parse(String string) {
        ...
        return new ShMediaType(string, type, subtype, charset);
    }
    ...
    public boolean equals(@Nullable Object other) {
        return other instanceof ShMediaType && ((ShMediaType) other).mediaType.equals(mediaType);
    }
