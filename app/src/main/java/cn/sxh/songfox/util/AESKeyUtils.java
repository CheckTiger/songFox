        ...
        if (!"".equals(alias)) {
            try {
                ...
                if (!keyStore.containsAlias(alias)) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR2) {
                        spec = new KeyPairGeneratorSpec.Builder(new android.app.Application())
                                .setAlias(alias)
