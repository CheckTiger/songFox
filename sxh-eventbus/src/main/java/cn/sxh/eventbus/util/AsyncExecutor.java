...
import cn.sxh.eventbus.EventBus;
...
public class AsyncExecutor {
    ...
    public static class Builder{
        ...
        private AsyncExecutor buildForScope(Object executionContext) {
            if (eventBus == null) {
            ...
            return new AsyncExecutor(threadPool,failureEventType,eventBus, executionContext);
        }
    }
    ...
    public AsyncExecutor(Executor threadPool, Class<?> failureEventType,
                         EventBus eventBus, Object scope) {
        this.threadPool = threadPool;
        this.eventBus = eventBus;
        this.scope = scope;
        try {
            ...
            public void run() {
                try {
                    ...
                    try {
                        ...
                        throw new RuntimeException("Could not create failure event", e);
                    }
